...
const ProductList = () => {
    ...
    if(!data) return <h2 className='font-bold text-center py-3 text-gray-600'>loading.....</h2>;
                    ...
                    <tbody>
                        ...
                        <tr className='bg-white border-b' key={product.id}>
                            ...
                            <td className='py-3 px-1 text-center'>
                                ...
                                className="font-medium bg-red-400 hover:bg-red-500 px-3 py-1 rounded text-white">Delete</button>
                            </td>
                        </tr>
                        ))}
                    </tbody>
